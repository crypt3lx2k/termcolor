...
/* xterm */
termcolor xterm_color (size_t n) {
  return colors[n];
}

/* xterm-16color */
termcolor xterm_16color_color (size_t n) {
  return colors[n];
}

/* xterm-88color */
termcolor xterm_88color_color (size_t n) {
  /* base colors */
  if (n < 16)
    return colors[n];
...
/* xterm-256color */
termcolor xterm_256color_color (size_t n) {
  /* base colors */
  if (n < 16)
    return colors[n];
